#! /bin/bash -e
#
# Powered by Late Lee 2017.10.31
#
echo "start jenkins config...."

#echo "starting docker service..."
# start docker server (we will build docker file under jenkins)
#service docker restart
export JENKINS_HOME=/var/lib/jenkins
export COPY_REFERENCE_FILE_LOG=/var/lib/jenkins/copy_reference_file.log
